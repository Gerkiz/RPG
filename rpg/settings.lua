...
function Public.extra_settings(player)
    ...
    data.character_item_drop_distance_bonus = create_bonus_label(player, setting_grid,
        ({ 'rpg_settings.drop_dist_label' }), ({ 'rpg_settings.drop_dist_tooltip' }),
    ...
    data.character_mining_speed_modifier = create_bonus_label(player, setting_grid,
        ({ 'rpg_settings.mining_speed_label' }), ({ 'rpg_settings.mining_speed_tooltip' }),
