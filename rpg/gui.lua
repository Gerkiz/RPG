...
local function draw_main_frame(player, location)
    ...
    local main_frame, inside_frame = Gui.add_main_frame_with_toolbar(player, 'screen', main_frame_name,
        settings_button_name, close_main_frame_name, 'RPG')
    ...
    add_gui_description(left_bottom_table, ({ 'rpg_gui.dexterity_name' }), w1,
        ({ 'rpg_gui.dexterity_tooltip', duped_items }))
    ...
    local mining_speed_value = round((player.force.manual_mining_speed_modifier + player.character_mining_speed_modifier + 1) *
        100) .. '%'
    ...
    local crafting_speed_value = round((player.force.manual_crafting_speed_modifier + player.character_crafting_speed_modifier + 1) *
        100) .. '%'
    add_gui_stat(right_bottom_table, crafting_speed_value, w2)

    add_gui_description(right_bottom_table, ' ', w0)
    add_gui_description(right_bottom_table, ({ 'rpg_gui.running_speed' }), w1)
    local running_speed_value = round((player.force.character_running_speed_modifier + player.character_running_speed_modifier + 1) *
        100) .. '%'
